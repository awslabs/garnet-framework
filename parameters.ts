...
export const Parameters = {
    ...
    // FARGATE PARAMETERS
    garnet_fargate: {
        fargate_cpu: 8192, // https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_definition_parameters.html#task_size
        fargate_memory_limit: 61440, // https://docs.aws.amazon.com/AmazonECS/latest/developerguide/task_definition_parameters.html#task_size
        autoscale_requests_number: 10, 
        autoscale_min_capacity: 20, 
    ...
    garnet_scorpio: {
        ...
        aurora_max_capacity: 20, // https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.setting-capacity.html#aurora-serverless-v2.max_capacity_considerations
