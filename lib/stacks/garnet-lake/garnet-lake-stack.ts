import { Aws, CustomResource, Duration, Lazy, Names, NestedStack, RemovalPolicy, Stack } from "aws-cdk-lib"
...
export class GarnetLake extends NestedStack {
    ...
    // LAMBDA THAT CREATES A SUBSCRIPTION IN THE BROKER TO SUBSCRIBE TO ALL ENTITIES
    ...
    functionName: `garnet-sub-all-lambda`, 
        description: 'Garnet Lake - Function that subscribes to all types in the broker to feed the Garnet Lake',
        runtime: Runtime.NODEJS_20_X,
