    ...
    try {
        ...
        for await (let msg of event.Records){
            ...
            if(ipAddress) { 
                ...
                payload.connectivityStatus.ipAddress = "urn:ngsi-ld:null"
            } 

            if(disconnectReason) { 
                payload.connectivityStatus.disconnectReason = disconnectReason 
            } else {
                payload.connectivityStatus.disconnectReason = "urn:ngsi-ld:null" 
            }
            ...
            if(clientInitiatedDisconnect !== undefined) {
                ...
                payload.connectivityStatus.clientInitiatedDisconnect = "urn:ngsi-ld:null"
            }
            ...
            let {data: res} = await axios.patch(`${dns_broker}/entities/${entity.id}`, entity, {headers: headers}) 
            console.log(res)
            } catch(e){
                console.log(e)
            } 
